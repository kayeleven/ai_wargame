...
| Workspace | Game/team/turn | Destination | Place for team authoring/submission | Player | Workspace | Trialed | Implemented entry, named saved regions, explicit conflict recovery and protected editor/command retries in 1U-1; action-volume layout and automatic teammate refresh remain 1U-3 | None; E1 |
| Amendment review | Authorized game/team/turn | Destination | Existing accept/reject task with immutable comparison | Adjudicator | Review | B-18 scoped; owner review pending | Dedicated page, pending/history links, changed-action/field anchors, full comparisons and retained decision recovery in 1U-2 PR 1 | Keyboard/narrow checks in [1U-2 verification](phase1/verification-1u-2.md); no new review authority |
| Rejected revision | Authorized team/turn | Workspace notice and submitted version | Inspect the rejected content and persistent reason | Player | Workspace | Owner review pending | Reason and scoped revision link in 1U-2 PR 1; full lifecycle presentation remains PR 4 | No adjudicator access granted |
