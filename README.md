...
This repository currently contains planning documents, not an implemented application. There is no selected implementation stack, installer, or dependency manifest yet.
